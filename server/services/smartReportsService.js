...
export const fetchEasyGainPercentage = () =>
  API.get('/smart-reports/easy-gain-percentage').then((r) => r.data);

export const updateEasyGainPercentage = (percentage) =>
  API.put('/smart-reports/easy-gain-percentage', { percentage }).then((r) => r.data);
